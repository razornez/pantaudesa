...
export default function ShareBar({ desaNama, kabupaten, provinsi }: ShareBarProps) {
  ...
  return (
    <div className="mx-auto max-w-[1080px] px-4 sm:px-6 py-3 border-b border-slate-100">
      <div className="flex flex-wrap items-center gap-2">
        <span className="text-xs font-medium text-slate-500 mr-1">Bagikan halaman ini:</span>
        ...
        <button
          onClick={handleCopy}
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-600 text-sm font-medium transition-colors"
        >
          {copied ? (
            <>
