export const BACK_OFFICE_COPY = {
  adminDesa: {
    ...
    profile: {
      ...
      metrics: {
        joined: "Bergabung",
        joinedNote: "Awal akses admin",
        renewal: "Renewal",
        renewalOn: "On",
        renewalOff: "-",
        renewalInactive: "Belum aktif",
        days: (days: number) => `${Math.abs(days)} hari`,
        desa: "Desa",
        location: "Lokasi lengkap",
        workArea: "Wilayah kerja admin kamu",
        inviteAccepted: "Undangan diterima",
        noInvite: "Tidak melalui undangan",
        nextRenewal: "Perpanjangan berikutnya",
        noSchedule: "Belum ada jadwal",
      },
      currentRole: {
        title: "Peran kamu saat ini",
        verified: "Kamu dapat mengelola anggota, menyetujui dokumen admin terbatas, dan mengirim dokumen untuk ditinjau PantauDesa.",
        limited: "Kamu bisa membantu unggah dokumen. Keputusan penting tetap menunggu admin utama desa.",
      },
      workStandard: {
      ...
      renewalAlert: {
        eyebrow: "Perhatian",
        overdueTitle: "Perpanjangan terlambat",
        urgentTitle: "Perpanjangan segera dibutuhkan",
        body: "Verifikasi Admin Desa perlu diperpanjang berkala. Jika token berhasil dicek, PantauDesa tetap perlu meninjau sebelum masa aktif diperbarui.",
      },
    },
    documents: {
    ...
    listAdmin: {
      ...
      inviteSection: { eyebrow: "Undangan", title: "Undangan yang masih menunggu", expired: "Sudah kedaluwarsa", pending: "Pending", expiredShort: "Expired", validUntil: (date: string) => `Berlaku sampai ${date}`, sentAt: (date: string) => `Dikirim ${date}` },
    ...
    notifications: {
      ...
      messages: { markAllReadSuccess: "Semua notifikasi ditandai dibaca.", markAllReadFailed: "Gagal.", markOneReadSuccess: "Notifikasi ditandai dibaca.", markOneReadFailed: "Gagal." },
      empty: "Belum ada notifikasi.",
      newBadge: "Baru",
    },
    suara: {
      category: { infrastruktur: "Infrastruktur", bansos: "Bansos", fasilitas: "Fasilitas", anggaran: "Anggaran", lingkungan: "Lingkungan", lainnya: "Lainnya" },
      status: { OPEN: "Terbuka", IN_PROGRESS: "Sedang ditangani", RESOLVED: "Selesai" },
      ...
      summary: { total: "Total suara", open: "Terbuka", replies: "Balasan", helpful: "Helpful", publicInput: "masukan publik", unresolved: "belum selesai", discussions: "diskusi tercatat", citizenResponse: "respon warga" },
