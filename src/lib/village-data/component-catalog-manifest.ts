...
export const DEFAULT_COMPONENT_CATALOG_MANIFEST: ComponentCatalogManifestEntry[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { fieldKey: "persentaseLulusSMA", label: "% Lulusan SMA+", valueType: "number", isPublishableNow: true, displayOrder: 8 },
      { fieldKey: "fasilitasUmum", label: "Fasilitas umum", valueType: "json", isPublishableNow: true, displayOrder: 9 },
