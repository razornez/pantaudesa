...
export const DEFAULT_COMPONENT_CATALOG_MANIFEST: ComponentCatalogManifestEntry[] = [
  {
    ...
    fields: [
      ...
      { fieldKey: "tahunData", label: "Tahun data", valueType: "number", isPublishableNow: true, displayOrder: 4 },
      { fieldKey: "kecamatan", label: "Kecamatan", valueType: "string", isPublishableNow: true, displayOrder: 5 },
      { fieldKey: "kabupaten", label: "Kabupaten/Kota", valueType: "string", isPublishableNow: true, displayOrder: 6 },
      { fieldKey: "provinsi", label: "Provinsi", valueType: "string", isPublishableNow: true, displayOrder: 7 },
      { fieldKey: "geoLat", label: "Koordinat lintang", valueType: "number", isPublishableNow: true, displayOrder: 8 },
      { fieldKey: "geoLng", label: "Koordinat bujur", valueType: "number", isPublishableNow: true, displayOrder: 9 },
      { fieldKey: "topografi", label: "Topografi", valueType: "string", isPublishableNow: true, displayOrder: 10 },
    ],
  },
  {
